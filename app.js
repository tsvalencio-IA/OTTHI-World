(() => {
  ...
  const OTTHI_GAME_WEB_BUILD = '700.0-five-stages-professional';
  window.OTTHI_GAME_VERSION = 700;
  ...
  function bootstrapOtthiWorldShell(){
    ...
    document.documentElement.dataset.otthiWorld='700';document.body.classList.add('otthi-world-shell');
  }
