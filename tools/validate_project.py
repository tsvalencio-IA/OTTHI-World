...
def main():
    required=['index.html','app.js','style.css','sw.js','manifest.webmanifest','release-manifest.json','VERSION.json','firebase-config.js','firebase-database.rules.json','athos.glb','src/module-order.json','assets/world/pbr-manifest.json','tools/build_project.py','tools/test_v701_gm_panel.py','tools/test_v703_recovery.py','tools/test_v7031_startup_order.py','tools/test_v704_world_reconstruction.py','tools/test_v7054_ottovias.py','tools/test_v7055_performance_recovery.py','tools/test_v7056_world_precision.py','tools/test_v7057_r3_ottovias_flow.py','tools/test_v7057_r4_world_integrity.py','tools/test_v7057_r5_vehicle_actions.py','tools/test_v7057_r6_gameplay_integrity.py','tools/test_v7057_r7_player_garage.py','tools/test_v7057_r7_garage_runtime.js','tools/test_v7057_r8_police_roadside_runtime.js','tools/test_v7057_r10_visual_fidelity.py','src/modules/33-otthi-world-professional-core.js','src/modules/34-avatar-studio-professional-v3.js','src/modules/35-world-render-pbr-environment.js','src/modules/36-modular-build-machines.js','src/modules/37-hero-platform-gameplay.js','src/modules/38-otthi-world-integration-bootstrap.js','src/modules/39-gm-admin-panel.js','src/modules/40-world-evolution-v702.js','src/styles/16-otthi-world-professional-v700.css','src/styles/17-gm-admin-panel-v701.css','src/styles/18-world-evolution-v702.css','.github/workflows/build-modular-app.yml','.github/workflows/gerar-apk.yml']
