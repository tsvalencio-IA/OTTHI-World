...
check('Observador tem limite de frequência', 'newsCheckAt<850' in source)
...
check('Retenção e normalização do trânsito são observadas', 'Atenção para retenção' in source and 'Fluxo normalizado' in source)
