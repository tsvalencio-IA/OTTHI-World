...
const records={roads:[],houses:[],vehicles:[],waters:[],largeBoxes:[],systems:{sports:0,kart:0,castle:0}};
...
assert.strictEqual(records.systems.sports,1,'complexo esportivo duplicado');assert.strictEqual(records.systems.kart,1,'kartódromo duplicado');assert.strictEqual(records.systems.castle,1,'castelo duplicado');
