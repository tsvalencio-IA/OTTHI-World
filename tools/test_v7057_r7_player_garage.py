...
check('Release R7 da garagem e oficina', version.get('assetVersion') == 70577 and version.get('release') == '705.7-player-garage-workshop-r7')
check('Android R7 sincronizado', version.get('androidVersionCode') == 70577 and version.get('androidVersionName') == '7.0.5.7.7')
