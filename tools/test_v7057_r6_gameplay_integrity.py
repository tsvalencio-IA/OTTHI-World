...
check('Policial desce e se aproxima visualmente', all(token in police for token in ['createRoadsidePoliceOfficer', "phase='officer-exiting'", "phase='approaching'", "phase='ticket-writing'", 'updatePoliceRoadsideStop']))
