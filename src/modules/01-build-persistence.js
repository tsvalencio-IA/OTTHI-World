...
// @otthi-module-body
  ...
  const defaultState = () => ({
    ...
    ottovias: { passes:0, spent:0, lastTollId:'', lastTollAt:0, tour:{ active:false, index:0, startedAt:0, bestMs:0, completed:0 }, communication:{ active:false, mode:'', index:0, startedAt:0, completed:0, specialComplete:false, questionsAnswered:0 }, news:[], newsSeq:0, lastBulletinAt:0 },
